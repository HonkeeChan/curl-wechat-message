...
class WXBot:
    ...
    def handle_msg(self, r):
        ...
        for msg in r['AddMsgList']:
            ...
            if msg['MsgType'] == 51:  # init message
                ...
                msg_type_id = 99
                print 'handle msg msg_type_id = 99, user: ', user
                user['name'] = 'unknown'
            if not user['name']:
                # print 'handle msg not user, user: ', user
                user['name'] = 'unknown'
    ...
    def login(self):
        ...
        r.encoding = 'utf-8'
        data = r.text
        # print 'in login, data: ', data
        # data
        """
        <error>
            <ret>0</ret>
            <message></message>
            <skey>@crypt_a5fa357f_235ccdce11c9a1dd5a120751762062f7</skey>
            <wxsid>HYOKdSh5O6j49omi</wxsid>
            <wxuin>418457795</wxuin>
            <pass_ticket>004MMMxsYovE6MG8fm1KQDd%2Fc%2Bz7hYjD0P39hUzgKUHjOVeGQtiszD2Dkh3%2FghNE</pass_ticket>
